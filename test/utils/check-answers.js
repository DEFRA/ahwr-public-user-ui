...
export const getRowActionTexts = ($) => {
  return $(".govuk-summary-list__actions")
    .map((index, element) => $(element).text().trim())
    .get();
};
export const getRowLinks = ($) => {
  return $(".govuk-summary-list__actions .govuk-link")
    .map((index, element) => $(element).attr("href"))
    .get();
};

export const commonVetRowKeys = ["Vet's name", "Vet's RCVS number"];

export const commonVetRowActionTexts = ["Change vet's name", "Change vet's rcvs number"];
...
export const beefReviewClaim = {
  ...baseReviewClaim,
  typeOfLivestock: "beef",
  numberAnimalsTested: "42",
  testResults: "positive",
  latestEndemicsApplication: { flags: [] },
};
export const dairyReviewClaim = {
  ...baseReviewClaim,
  typeOfLivestock: "dairy",
  testResults: "positive",
  latestEndemicsApplication: { flags: [] },
};
export const pigsReviewClaim = {
  ...baseReviewClaim,
...
export const expectedReviewBeef = {
  ...
  rowLinks: [
    ...
    "/livestock/test-date",
    "/livestock/species-numbers",
    "/livestock/number-of-species-tested",
    "/livestock/vet-name",
    "/livestock/vet-rcvs",
    "/livestock/test-urn",
    "/livestock/test-results",
  ],
};
...
export const expectedReviewPigsPostPigsAndPaymentsGolive = {
  ...
  rowLinks: [
    ...
    "/livestock/vet-rcvs",
    "/livestock/test-urn",
    "/livestock/samples-types",
    "/livestock/blood-sample-number",
    "/livestock/test-results",
  ],
};
...
export const beefEndemicsFollowUpClaim = {
  ...baseEndemicsFollowUpClaim,
  typeOfLivestock: "beef",
  numberAnimalsTested: "42",
  testResults: "positive",
  biosecurity: "yes",
...
export const dairyEndemicsFollowUpClaim = {
  ...baseEndemicsFollowUpClaim,
  typeOfLivestock: "dairy",
  testResults: "positive",
  biosecurity: "yes",
...
export const pigEndemicsFollowUpClaim = {
  ...baseEndemicsFollowUpClaim,
  typeOfLivestock: "pigs",
  numberAnimalsTested: "42",
  numberOfSamplesTested: "5",
  pigsElisaTestResult: "positive",
  herdVaccinationStatus: "vaccinated",
  biosecurity: { biosecurity: "yes", assessmentPercentage: "50" },
  latestEndemicsApplication: { flags: [] },
};
export const sheepEndemicsFollowUpClaim = {
  ...baseEndemicsFollowUpClaim,
  typeOfLivestock: "sheep",
  numberAnimalsTested: "42",
...
export const dairyEndemicsFollowUpClaimPiHuntDeclined = {
  ...dairyEndemicsFollowUpClaim,
  dateOfTesting: undefined,
  piHunt: "no",
};
...
export const expectedEndemicsFollowUpBeef = {
  ...
  rowLinks: [
    ...
    "/livestock/test-urn",
    "/livestock/test-results",
    "/livestock/biosecurity-assessment",
  ],
};
...
export const expectedEndemicsFollowUpPigs = () => ({
  ...
  rowLinks: [
    ...
    "/livestock/test-urn",
    "/livestock/number-of-samples-tested",
    "/livestock/pigs-elisa-result",
    "/livestock/biosecurity-assessment",
  ],
});
...
export const expectedEndemicsFollowUpSheep = {
  ...
  rowLinks: [
    ...
    "/livestock/vet-rcvs",
    "/livestock/test-urn",
    "/livestock/sheep-endemics-package",
    "/livestock/sheep-tests",
    "/livestock/sheep-test-results?diseaseType=flystrike",
    "/livestock/sheep-test-results?diseaseType=sheepScab",

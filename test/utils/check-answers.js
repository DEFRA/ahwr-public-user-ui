...
export const expectedEndemicsFollowUpSheep = {
  ...
  rowLinks: [
    ...
    "/vet-rcvs",
    "/test-urn",
    "/sheep-endemics-package",
    "/sheep-tests",
    "/sheep-test-results?diseaseType=flystrike",
    "/sheep-test-results?diseaseType=sheepScab",
    "/sheep-test-results?diseaseType=other",
  ],
};

...
describe('PI Hunt tests when Optional PI Hunt is OFF', () => {
  ...
  describe(`POST ${url} route`, () => {
    ...
    test('Continue to ineligible page if user select no and clear PI Hunt data when relevantReviewForEndemics=REVIEW', async () => {
      ...
      getSessionData.mockImplementationOnce(() => { return { typeOfLivestock: 'beef', relevantReviewForEndemics: { type: 'REVIEW' } } })
    ...
    test('Continue to ineligible page if user select no and does not clear PI Hunt data when relevantReviewForEndemics=VV', async () => {
      ...
      getSessionData.mockImplementationOnce(() => { return { typeOfLivestock: 'beef', relevantReviewForEndemics: { type: 'VV' } } })
    ...
    test('shows error when payload is invalid', async () => {
      getSessionData.mockImplementation(() => { return { typeOfLivestock: 'beef', reviewTestResults: 'positive' } })
      const options = {
        method: 'POST',
        url,
        auth,
...
describe('PI Hunt tests when Optional PI Hunt is ON', () => {
  ...
  describe(`POST ${url} route`, () => {
    ...
    test.each([
      ...
      getSessionData.mockImplementationOnce(() => { return { reviewTestResults } })
    ...
    test('Continue to ineligible page if user select no', async () => {
      ...
      getSessionData.mockImplementationOnce(() => { return { reviewTestResults: 'negative', relevantReviewForEndemics: { type: 'FOLLOW_UP' } } })

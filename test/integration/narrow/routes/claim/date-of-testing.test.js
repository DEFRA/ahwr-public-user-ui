...
describe('Date of testing when isMultipleHerdsUserJourney=true', () => {
  ...
  test('returns 200 and correct backlink when skipSameHerdPage=true', async () => {
    getSessionData.mockReturnValue({ typeOfReview: 'FOLLOW_UP', typeOfLivestock: 'beef',
      latestEndemicsApplication: { createdAt: new Date('2022-01-01') }, reference: 'TEMP-6GSE-PIR8', previousClaims: [] })
  ...
  test('returns 200 and correct backlink when skipSameHerdPage=false', async () => {
    getSessionData.mockReturnValue({ typeOfReview: 'FOLLOW_UP', typeOfLivestock: 'beef',
      latestEndemicsApplication: { createdAt: new Date('2022-01-01') }, reference: 'TEMP-6GSE-PIR8', previousClaims: [{ data: { typeOfLivestock: 'beef' } }] })
  ...
  test('returns 200 and correct backlink when beef follow-up post PIHuntAndDairy golive', async () => {
    getSessionData.mockReturnValue({ typeOfReview: 'FOLLOW_UP', typeOfLivestock: 'beef', latestEndemicsApplication: { createdAt: new Date('2025-06-06') }, reference: 'TEMP-6GSE-PIR8' })

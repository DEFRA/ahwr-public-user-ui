...
describe("Vaccination test", () => {
  ...
  describe(`POST ${url} route`, () => {
    ...
    test.each([
      ...
      async ({ herdVaccinationStatus, errorMessage }) => {
        const options = {
          method: "POST",
          url,
          auth,
    ...
    test.each([
      ...
      "returns 200 when payload is valid and stores in session (herdVaccinationStatus= $herdVaccinationStatus)",
      async ({ herdVaccinationStatus }) => {
        const options = {
          method: "POST",
          url,
          auth,

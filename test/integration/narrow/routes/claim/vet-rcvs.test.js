  ...
  describe(`POST ${url} route`, () => {
    ...
    test.each([
      ...
      async ({ vetRCVSNumber, reviewTestResults, nextPageURL }) => {
        getSessionData.mockImplementation(() => {
          return { reviewTestResults, typeOfLivestock: "beef" };
        });
    ...
    test.each([
      ...
      async ({ typeOfLivestock, typeOfReview, relevantReviewForEndemics, nextPageURL }) => {
        getSessionData.mockImplementation(() => {
          return { typeOfLivestock, typeOfReview, relevantReviewForEndemics };
        });
        const options = {
          method: "POST",
          url,

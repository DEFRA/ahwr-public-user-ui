...
const getHandler = {
  method: "GET",
  path: claimRoutes.whichSpeciesPoultry,
  options: {
    handler: async (request, h) => {
      ...
      return h.view(claimViews.whichSpeciesPoultry, {
        ...(typeOfLivestock && {
    ...
    validate: {
      payload: Joi.object({
        typeOfLivestock: Joi.string()
          .valid(...Object.values(TYPE_OF_POULTRY))
          .required(),
      }),
...
export const whichSpeciesPoultryHandlers = [getHandler, postHandler];

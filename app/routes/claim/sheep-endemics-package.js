...
const options = {
  hintHtml:
    "You can find this on the summary the vet gave you. The diseases the vet might take samples to test for are listed with each package.",
};
...
const postHandler = {
  ...
  options: {
    validate: {
      payload: Joi.object({
        sheepEndemicsPackage: Joi.string()
          .valid(
